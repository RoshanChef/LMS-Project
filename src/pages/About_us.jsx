...
import Quote from '../components/core/About_us/Quote';
import HighlightText from '../components/core/Homepage/HighlightText';
import BannerImage1 from "../assets/images/aboutus1.webp";
import BannerImage2 from "../assets/images/aboutus2.webp";
import BannerImage3 from "../assets/images/aboutus3.webp";
import FoundingStory from "../assets/images/FoundingStory.png";
import Stats from '../components/core/About_us/Stats';
    ...
    return (
        <div className='text-white'>
            ...
            <section className="bg-[#2C333F]">
                <div className="relative mx-auto flex w-11/12 max-w-max flex-col justify-between gap-10 text-center text-white">
                    <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                        ...
                        <div className="absolute -my-8 bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
