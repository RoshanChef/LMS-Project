...
function InstructorSec() {
    return (
        <div className='bg-[#01050c]  p-5 flexgap-20 items-center'>

            <div className='flex  flex-col lg:flex-row  w-11/12 mx-auto my-12 gap-18'>
                ...
                <div className='lg:w-[45%] w-full font-semibold flex flex-col gap-4 justify-center'>
