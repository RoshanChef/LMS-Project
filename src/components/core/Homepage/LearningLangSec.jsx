...
function LearningLangSec() {
  return (
    <div className='text-black items-center  flex flex-col w-full text-4xl font-semibold text-center my-28'>
      <div>
        <h1 className='text-4xl font-semibold text-center my-4'>Your swiss knife for <HighlightText text="learning any language" /></h1>
      ...
      <div className='flex items-center justify-center'>
        <img src={Card1} alt="img1" className='object-contain -mt-4 -mr-36' />
        <img src={Card2} alt="img2" className='object-contain ' />
        <img src={Card3} alt="img3" className='object-contain -ml-36 -mt-14' />
      </div>
