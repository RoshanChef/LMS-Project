...
import { deleteSubSection, deleteSection } from '../../../../../services/operations/courseDetailAPI';
            ...
            <details key={section._id} open className='mt-4'>
              <summary className='flex cursor-pointer items-center justify-between border-b-2 border-b-gray-600 py-2'>
                ...
                <div className='flex items-center gap-x-3'>
                  ...
                  <button>
                    <VscTrash className='text-lg cursor-pointer text-gray-300' onClick={() => {
              ...
              <div className='px-6 pb-4'>
                  ...
                  section.subSection.map((subSection) => (
                    <div
                      ...
                      <div className='flex items-center gap-x-3' onClick={e=>e.stopPropagation()}>
                        ...
                        <button>
                          <VscTrash className='text-lg cursor-pointer text-gray-500 z-50' size={21} onClick={() => {
                            setConfirmationModal({
                ...
                <button onClick={() => setAddSubSection(section._id)} className='mt-3 cursor-pointer flex items-center gap-x-1 text-yellow-400 font-bold'>
